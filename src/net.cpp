...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Altbit " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"altbit.org", "138.68.26.206"},
    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
    {"altbittools.com", "testnet-seed.altbittools.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Altbit is probably already running."), addrBind.ToString().c_str());
        else
